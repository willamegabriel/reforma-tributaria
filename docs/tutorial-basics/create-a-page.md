...
Na Natureza de Operações, a única alteração realizada foi a inclusão do Tipo de Operação. As mudanças são:

- Inclusão de um novo campo chamado Tipo de Operação no cadastro de Natureza de Operações.
